...
exports.MutationQueryFunction = exports.newFunctionToJson = void 0;
...
function newFunctionToJson(rowHeaderName, element, configIndex) {
    return {
        "id": element,
        "owner": "Skyline",
        "configCategories": [
...
exports.newFunctionToJson = newFunctionToJson;
function MutationQueryFunction(result) {
    try {
        for (let index = 0; index < result.length; index++) {
            const jsondata = JSON.stringify(result[index]);
          ...
          AddBussinessEntityWithConfig(businessEntity: $businessEntity)
            ...
            (async () => {
                ...
                const rawResponse = await (0, node_fetch_1.default)(url, {
                    method: 'POST',
                    headers: {
...
exports.MutationQueryFunction = MutationQueryFunction;
